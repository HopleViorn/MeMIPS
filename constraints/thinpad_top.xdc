...
# set_output_delay -clock clk_out1_clk_wiz_0 5  [get_ports ext_ram_data]
set_input_delay -clock clk_out1_clk_wiz_0 12.000 [get_ports ext_ram_data]
# set_output_delay -clock clk_out1_clk_wiz_0 5 [get_ports ext_ram_addr]
# set_output_delay -clock clk_out1_clk_wiz_0 5 [get_ports ext_ram_be_n]
# set_output_delay -clock clk_out1_clk_wiz_0 5  [get_ports ext_ram_ce_n]
# set_output_delay -clock clk_out1_clk_wiz_0 5  [get_ports ext_ram_we_n]
# set_output_delay -clock clkclk_out1_clk_wiz_0_50M 5  [get_ports ext_ram_we_n]

# set_output_delay -clock clk_out1_clk_wiz_0 5  [get_ports base_ram_data]
set_input_delay -clock clk_out1_clk_wiz_0 12.000 [get_ports base_ram_data]
# set_output_delay -clock clk_out1_clk_wiz_0 5 [get_ports base_ram_addr]
# set_output_delay -clock clk_out1_clk_wiz_0 5 [get_ports base_ram_be_n]
# set_output_delay -clock clk_out1_clk_wiz_0 5  [get_ports base_ram_ce_n]
# set_output_delay -clock clk_out1_clk_wiz_0 5  [get_ports base_ram_we_n]
# set_output_delay -clock clk_out1_clk_wiz_0 5  [get_ports base_ram_we_n]
